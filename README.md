...
# Python
I have not yet set up my Python development environment yet and might migrate to uv for managing packages and virtual environments. The notes below are for my old setupand should not be followed.
