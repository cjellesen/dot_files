...
-- Navigating windows
vim.keymap.set("n", "<C-h>", "<C-w>h", { desc = "Navigate to left hand window" })
vim.keymap.set("n", "<C-l>", "<C-w>l", { desc = "Navigate to right hand window" })
vim.keymap.set("n", "<C-j>", "<C-w>j", { desc = "Navigate to lower window" })
vim.keymap.set("n", "<C-k>", "<C-w>k", { desc = "Navitgate to upper window" })
